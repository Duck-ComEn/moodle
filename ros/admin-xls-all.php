...
if($_GET[sup]=='All' || $_GET[sup]==''){
					...
					$u=1;
						echo"<table border=1><tr><th>No.</th><th>E/N</th><th>Name</th><th>Course</th><th>Time</th><th>Remark</th><th>RemainTime</th><th>Supervisor</th></tr>";
				/*		$result1=mysql_query("SELECT
												mdl_user.idnumber,
												mdl_user.firstname,
												mdl_user.lastname,
						...
						echo"<tr><td align=center>".($u++).".</td><td>{$data1['idnumber']}</td><td>".$data1['firstname'].' '.$data1['lastname']."</td><td>{$data1['fullname']}</td><td>".$q."</td><td align=center>{$data1['remark']}</td><td align=center>expire</td><td>".ucwords($data1['institution'])."</td></tr>";
						$i++;
						}
					/*	$result2=mysql_query("SELECT
												mdl_user.firstname,
						...
						echo"<tr><td align=center>".($u++).".</td><td>{$data2['idnumber']}</td><td>".$data2['firstname'].' '.$data2['lastname']."</td><td>{$data2['subject']}</td><td>".$next_date."</td><td align=center>{$data2['remark']}</td><td align=center>expire</td><td>".ucwords($data2['institution'])."</td></tr>";
						$i++;
						}
						...
						$idat=mysql_result($result,$i,7);
							...
							echo"<tr><td align=center>".$u++.".</td><td>".$a[$i][0]."</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>".$a[$i][3]."</td><td align=center>-</td><td align=center>{$a[$i][4]}</td><td>".ucwords($a[$i][5])."</td></tr>";
						}
