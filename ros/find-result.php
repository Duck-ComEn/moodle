...
<head>
	...
	<?php
		...
		case "super" : 
	?>
	<title>Benchmark Garde - Supervisor::ผลการสอบของพนักงาน</title>
...
//					mysql_select_db($database_ros, $ros);
				...
				?>
				<div align="justify" style="font-size: 16pt">ผลการสอบของพนักงาน<br>
				<a href="super-pdf-each.php?idnumber=<?php echo $_GET['idnumber']?>" target="_blank"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				<table id="mytable" cellspacing="0">
					...
					//				echo "<td align=center>".$today['mday'].'/'.$today['mon'].'/'.$today['year']."</td>";
								}else if($p==2){
									@$a1=mysql_result($result,$e,1);
									if($a1==1){
										print "<td width=40 align=center>".round((mysql_result($result,$e,2)/mysql_result($result,$e,4)),2)*100 ."%</td>";
						...
						//			echo "<td align=center>".$today['mday'].'/'.$today['mon'].'/'.$today['year']."</td>";
									...
									if($a1==1){
										...
										//$e++; 
									}echo "<td align='center' width=40>-</td><td align='center' width=40>-</td> ";
									$fday = getdate(mysql_result($result,$e-1,3));
									$day= $fday['mday'].'/'.$fday['mon'].'/'.$fday['year'];
									print "<td align=center>".$day."</td>";
									$today = getdate(mysql_result($result,$e-1,3));
