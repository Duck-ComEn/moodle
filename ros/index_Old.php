...
<form id="form1" name="form1" method="post" action="login.php">
 <div id="topheader">
   <div class="logo"></div>
   <!-- <div class="menu_area"><a href="#" class="ideas">Ideas <span class="menu_text">Maecenas lacin</span></a> <a href="#" class="links">Links <span class="menu_text">Maecenas</span></a> <a href="#" class="info">Info <span class="menu_text">Maecenas</span></a> <a href="#" class="works">Works <span class="menu_text">Maecenas</span></a></div> -->
 </div>
  <div id="search_strip">
...
<!--	<div class="comments_area">
  ...
  <div class="midarea">
    <div class="head"> Welcome to Benchmark Garde</div>
    <div class="body_textarea">
      <div align="justify">These templates are licensed under a Creative Commons Attribution 2.5 License.</div>
    </div>
	<br>
	<div class="login_area2">
      <div class="login_top2"></div>
      <div class="login_bodyarea2">
			<div class="right_head">
				<div align="center">Pleas Login </div>
			</div>
	...
	<table width="264" border="0" align="center">
        ...
        <tr>
          <td colspan="2"><div align="center">
              <label>
              <input type="submit" name="login" id="login" value="  เข้าสู้ีระบบ  " />
              </label>
          </div></td>
        </tr>
      </table>
    ...
    <div class="body_textarea">
      <div align="justify">
        <p>temper is a free, tableless, W3C-compliant  web design layout by Template World. This template has been tested and  proven compatible with all major browser environments and operating  systems. You are free to modify the design to suit your tastes in any  way you like.</p>
    ...
    <div class="innerbanner"><span class="innerbanner_head">Blandit ultricies urna velit congue ligula sed vulputate urna </span><br />
