	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<div align="justify">
				  <p>แสดงรายวิชาที่ต้อง Recertification</p>
			    </div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
				 <table id="mytable"  cellspacing="0">
					...
					$u=1;
						echo"<tr><th>No.</th><th>E/N</th><th>Name</th><th>Course</th><th>Time</th><th>RemainTime</tr>";
						...
						echo"<tr><td align=center>".($u++).".</td><td>{$data1['idnumber']}</td><td>".$data1['firstname'].' '.$data1['lastname']."</td><td>{$data1['fullname']}</td><td>".$q."</td><td>expire</td></tr>";
						$i++;
						}
						...
						echo"<tr><td align=center>".($u++).".</td><td>{$data2['idnumber']}</td><td>".$data2['firstname'].' '.$data2['lastname']."</td><td>{$data2['subject']}&nbsp;&nbsp;<img src=images/ICON_Remark/".$data2['remark']."_x20.gif></td><td>".$next_date."</td><td>expire</td></tr>";
						$i++;
						}
						...
						continue;
							...
							echo"<tr><td align=center>".$u++.".</td><td>".$a[$i][0]."</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>".$a[$i][3]."</td><td>";if($a[$i][4]=='expire'){echo "expire";}else {echo $a[$i][4];}echo"</td></tr>";
						}
...
<?php
	break ;
	default : echo"<center><h2>หน้านี้อนุญาติให้พนักงานเข้าใช้เท่านั้น</h2></center><bt><br>";
