...
<head>
	...
	<?php
		...
		case "super" : 
	?>
	<title>Benchmark Garde - Supervisor::ผลการสอบของพนักงานทั้งหมด</title>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify" style="font-size: 16pt">ผลการสอบของพนักงานทั้งหมด<br></div>
				<div id="mytable">
				<table id="mytable" cellspacing="0">
					<?php
						...
						ORDER BY
							...
							@$num_rows=mysql_num_rows($result);
						if(!$num_rows){
							echo "<meta http-equiv='refresh' content=0;URL=main-super-en-result.php>";
						}
						$i=1;
						...
						while($data = mysql_fetch_array($result)){
							echo"<tr>";
							print"<td>{$i}.</td><td><a href='find-result.php?idnumber=".$data['idnumber']."'>".$data['idnumber']."</a></td><td>{$data['firstname']}</td><td>{$data['lastname']}</td>";
							echo"</tr>";
							$i++;
						}
						echo"</table>";
