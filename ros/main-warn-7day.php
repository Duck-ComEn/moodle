...
<head>
	...
	<?php
		...
		case "admin" : 
	?>
	<title>Benchmark Garde - Administrator::แจ้งเตือน 7 วัน</title>
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<div align="justify">
				  ...
				  <p>&nbsp;</p>
				  <form id="form1" name="form1" method="get" action="main-warn-7day.php">
						...
						<label><?php
												$sql = "SELECT DISTINCT
														...
														// ส่ง sel_product ที่เป็นขื่อ sup ไปยัง send-mail-7.php 
				...
				<!--แทนตัวแปร mail = ucwords($_GET[sel_product]) เอาไปใช้กับหน้า send-mail-7.php  -->
				<div><a href="send-mail-7.php?mail=<?php echo ucwords($_GET[sel_product]); ?>"><img src="images\Mail_logo4.png" align="right" border="0" width="64" height="64" alt="Mail"></a><a href="admin-pdf-7.php?sup=<?php echo $_GET[sel_product]?>" target="_blank"><img src="images\PDF_Logo.png" align="right" border="0" width="64" height="64"></a><a href="admin-exl-7.php?sup=<?php echo $_GET[sel_product]?>" target="_blank"><img src="images\Excel2007Logo.png" align="right" border="0" width="60" height="64"></a></div>
			</div>
			<div class="body_textarea">
				<div id="mytable">
						...
						*/
						...
						$result=mysql_query("SELECT
											...
											union all select
														...
														ros_score.max,
														ros_score.date_time,
														CONCAT('m',mdl_user.id,'&fname=',mdl_user.firstname,'&lname=',mdl_user.lastname,'&subject=',REPLACE(ros_score.`subject`, ' ', '+')) AS id,
														mdl_user.institution
													FROM
														ros_score
						...
						$resultnot1=mysql_query("SELECT
							...
							// (ucwords($_GET[sel_product]) ==> ucwords สร้าง First Capital เป็นตัวใหญ่
						    // sel_product เป็น ชื่อ sup จาก form ด้วย method GET
							echo"<center><h3>แสดงในสังกัดคุณ ".ucwords($_GET[sel_product])."</h3></center><br>";
							}
		...
		//				echo "<tr><td align=center>".($u++).".</td><td>{$data1['idnumber']}</td><td>".$data1['firstname'].' '.$data1['lastname']."</td><td>{$data1['fullname']}&nbsp;&nbsp;<img src=images/ICON_Remark/".$data1['remark']."_x20.gif></td><td>".$q;if(@in_array($idat, $notshow)){ echo"&nbsp;&nbsp;<a href=show.php?id=".$idat."><img src=images/show1.gif></a>";}else{echo"&nbsp;&nbsp<a href=notshow.php?id=".$idat."><img src=images/hide1.gif></a>";}echo"</td><td>";if($qn=='expire'){echo"<a href=update-expire.php?id=".$idat.">expire</a> &nbsp;&nbsp;(".$dateremark.")";}else {echo $qn;};echo"&nbsp;&nbsp;<input name=\"btnButton1\" type=\"button\" value=\"S\" OnClick=\"JavaScript:fncAlert('".ucwords($data1['institution'])."');\"></td></tr>";
			...
			//			echo"<tr><td align=center>".($u++).".</td><td>{$data2['idnumber']}</td><td>".$data2['firstname'].' '.$data2['lastname']."</td><td>{$data2['subject']}&nbsp;&nbsp;<img src=images/ICON_Remark/".$data2['remark']."_x20.gif></td><td>".$next_date; if(@in_array($data2['manual'], $notshow1)){ echo"&nbsp;&nbsp;<a href=show.php?id=m".$data2['manual']."><img src=images/show1.gif></a>";}else{echo"&nbsp;&nbsp<a href=notshow.php?id=m".$data2['manual']."><img src=images/hide1.gif></a>";}echo"</td><td><a href=update-expire.php?id=m".$data2['manual'].">expire</a> &nbsp;&nbsp;(".$data2['date'].")&nbsp;&nbsp;<input name=\"btnButton1\" type=\"button\" value=\"S\" OnClick=\"JavaScript:fncAlert('".ucwords($data2['institution'])."');\"></td></tr>";
						...
						if($a[$i][4]>7||$a[$i][4]=='expire'){
							...
							echo"<tr><td align=center>".$u++.".</td><td>".$a[$i][0]."</td><td>{$a[$i][1]}</td><td>{$a[$i][2]}</td><td>".$a[$i][3]; if(@in_array($idat, $notshow3)){ echo"&nbsp;&nbsp;<a href=show7.php?id=".$idat."><img src=images/show1.gif></a>";}else{echo"&nbsp;&nbsp<a href=notshow7.php?id=".$idat."><img src=images/hide1.gif></a>";}echo"</td><td>";if($a[$i][4]=='expire'){echo "<a href=expire.php?id=".$idat.">expire</a>";}else {echo $a[$i][4];}echo"&nbsp;&nbsp;<input name=\"btnButton1\" type=\"button\" value=\"S\" OnClick=\"JavaScript:fncAlert('".ucwords($a[$i][5])."');\"></td></tr>";
						}
