...
$html = "<br><br><br><br>
 <table border=0 align=center>
	  ...
	  <td width=84>&nbsp;</td>
        ...
        <td width=300><u>".strtoupper($rowLogin['department'])."</u></td>
      </tr>
      <tr>
	  <td width=84>&nbsp;</td>
        <td width=84><b>Supervisor</b></td>
        <td width=300><u>".ucwords($rowLogin['institution'])."</u></td>
		<td width=84><b>Branch<b></td>
		<td width=300><u>".ucwords($rowLogin['city'])."</u></td>
      </tr>
      <tr>
	  <td width=84>&nbsp;</td>
...
$result2=mysql_query("SELECT
										...
										$table.="<tr><td width=475>{$data['subject']}</td><td align=center width=45>";if($data['time1']=='0'){ $table.= "-";}else {$table.= round(($data['time1']/$data['max']),2)*100 .'%';} $table.="</td><td align=center width=45>";if($data['time2']=='0'){ $table.= "-";}else {$table.= round(($data['time2']/$data['max']),2)*100 .'%';} $table.="</td><td align=center width=45>";if($data['time3']=='0'){ $table.= "-";}else {$table.= round(($data['time3']/$data['max']),2)*100 .'%';} $table.="</td><td align=center width=80>{$day1}</td><td align=center width=80>{$day2}</td></tr>";
										}
$table.="</table>";
