...
<?php
	...
	//	mysql_select_db($database_ros, $ros);
		...
		$insertGoTo = "super_admin-add-s.php";
		if (isset($_SERVER['QUERY_STRING'])) {
...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::เพิ่ม Supervisor</title>
...
<?php
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify" style="font-size: 16pt">เพิ่ม Supervisor</div><br>
...
<?php
	break ;
	default : echo"<center><h2>หน้านี้อนุญาติให้ผู้ดูแลระบบเสูงสุดข้าใช้เท่านั้น</h2></center><bt><br>";
