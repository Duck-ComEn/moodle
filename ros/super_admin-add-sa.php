...
<?php
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
		$insertSQL = sprintf("INSERT INTO ros_user_admin (firstname, lastname, username, password, email, user_right) VALUES (%s, %s, %s, %s, %s, \"superadmin\")",
	...
	//	mysql_select_db($database_ros, $ros);
		...
		$insertGoTo = "super_admin-add-sa.php";
		if (isset($_SERVER['QUERY_STRING'])) {
...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::เพิ่ม SuperAdmin</title>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify" style="font-size: 16pt">เพิ่ม SuperAdministrator</div><br>
