...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::เพิ่มคะแนนพนักงาน</title>
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				<div align="justify">
				  ...
				  <p>&nbsp;</p>
				  <form id="form1" name="form1" method="POST" action="super_admin-add-score.php">
...
<td width="112"><label>
	...
	if($totalRows == 1){ // กรณีที่ชื่อผู้ใช้ และรหัสผ่านถูกต้อง จะกำหนดค่าตัวแปร Session เพื่อให้เรียกใช้ได้ทุกเพจ
		...
		echo "<meta http-equiv='refresh' content='0;URL=super_admin-add-score1.php'>";
