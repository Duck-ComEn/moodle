...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::แก้ไขสมาชิก</title>
			...
			<div class="body_textarea">
				...
				<table id="mytable" cellspacing="0">
					<?php 
						...
						while($data = mysql_fetch_array($result)){
							echo"<tr>";
							echo"<td><a href='super_admin-update-user.php?user={$data['username']}'>{$data['username']}</a></td><td>".$data['firstname']."  ".$data['lastname']."</td><td>{$data['user_right']}</td><td align=center><a href='super_admin-deluser.php?user={$data['username']}'>Delete</a> </td>";
							echo"</tr>";
						}
						echo"</table>";	
					?>
