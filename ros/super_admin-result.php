...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::ผลสอบพนักงาน</title>
	...
	<div id="body_area">
		...
		<div class="midarea">
			...
			<div class="body_textarea">
				...
				<form id="form1" name="form1" method="get" action="super_admin-result.php">
				...
				<table id="mytable" cellspacing="0">
					...
					if($_GET[sel_product]=='All' || $_GET[sel_product]==''){
						...
						while($data = mysql_fetch_array($result)){
							echo"<tr>";
							print"<td><a href='super_admin-find-result.php?idnumber=".$data['idnumber']."'>".$data['idnumber']."</a></td><td>{$data['firstname']}</td><td>{$data['lastname']}</td>";
							echo"</tr>";
						}
						echo"</table>";
					?>
