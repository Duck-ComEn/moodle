...
<head>
	...
	<?php
		...
		case "superadmin" : 
	?>
	<title>Benchmark Garde - SuperAdministrator::เพิ่มหมายเหตุการหมดอายุ</title>
				  ...
				  <form id="form1" name="form1" method="POST" action="">
				    <table width="491" border="0">
                      <tr>
                        ...
                        <td width="138"><div align="right"><span class="style6"><?php if($_GET['id'][0]=='m'){echo"<a href=super_admin-delete-remark-m.php?id=".substr($_GET['id'],1).">ลบ Remark นี้</a>";}else {echo"<a href=super_admin-delete-remark.php?id=".$_GET['id'].">ลบ Remark นี้</a>";} ?></span></div></td>
                      </tr>
                      <tr>
