...
echo"<tr><td>".$c++."</td><td>".$sent_time."</td><td align=center>";if($data['status']==0){echo"-";}else{echo $data['status'];}echo"</td><td>".$rev_time."</td><td><a href=super_admin-del-mail.php?id=".$data['id']."&sup=".$firstname.'+'.$lastname.">Del</a></td></tr>";
}
echo"</table>";
